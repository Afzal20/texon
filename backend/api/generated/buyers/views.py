...
class BuyerPortfolioViewSet(
    ...
    queryset = BuyerPortfolio.objects.select_related('organization').all()
...
class BuyerRatingViewSet(
    ...
    queryset = BuyerRating.objects.select_related('organization').all()
