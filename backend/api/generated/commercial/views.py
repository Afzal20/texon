...
class BillOfExchangeViewSet(
    ...
    queryset = BillOfExchange.objects.select_related('organization').all()
...
class LCViewSet(
    ...
    queryset = LC.objects.select_related('organization').all()
...
class ShipmentViewSet(
    ...
    queryset = Shipment.objects.select_related('organization').all()
