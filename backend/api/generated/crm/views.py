...
class BuyerCommunicationViewSet(
    ...
    queryset = BuyerCommunication.objects.select_related('organization').all()
...
class BuyerProfitabilityViewSet(
    mixins.CreateModelMixin,
    mixins.RetrieveModelMixin,
    mixins.UpdateModelMixin,
    mixins.DestroyModelMixin,
    ...
    queryset = BuyerProfitability.objects.select_related('organization').all()
...
class OrderAmendmentHistoryViewSet(
    ...
    queryset = OrderAmendmentHistory.objects.select_related('organization').all()
