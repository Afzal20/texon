...
class BuyerEnquiryViewSet(
    ...
    queryset = BuyerEnquiry.objects.select_related('organization').all()
...
class DevelopmentMonitoringViewSet(
    ...
    queryset = DevelopmentMonitoring.objects.select_related('organization').all()
...
class SMVRecordViewSet(
    ...
    queryset = SMVRecord.objects.select_related('organization').all()
...
class StyleAnalysisViewSet(
    ...
    queryset = StyleAnalysis.objects.select_related('organization').all()
