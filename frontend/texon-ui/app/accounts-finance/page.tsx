...
const modules = [
  { title: "Accounts Payable", description: "Supplier obligations, approvals, and payment runs.", href: "/accounts-finance/accounts-payable", icon: ReceiptText, metric: "$1.82M open" },
  { title: "Accounts Receivable", description: "Buyer invoices, collections, and aging exposure.", href: "/accounts-finance/accounts-receivable", icon: CircleDollarSign, metric: "$2.46M open" },
  { title: "Supplier Bills", description: "Bill validation with PO and GRN matching.", href: "/accounts-finance/supplier-bills", icon: FileBarChart2, metric: "14 in review" },
  { title: "Buyer Payments", description: "Inbound receipts, advances, and allocation.", href: "/accounts-finance/buyer-payments", icon: Banknote, metric: "$1.18M received" },
  { title: "Cost Center Tracking", description: "Budget utilization and departmental spend.", href: "/accounts-finance/cost-center-tracking", icon: Building2, metric: "72.4% utilized" },
  { title: "Order-wise Profit & Loss", description: "Actual margin insight across active orders.", href: "/accounts-finance/order-wise-profit-loss", icon: TrendingUp, metric: "16.8% avg margin" },
  { title: "Bank & Cash Management", description: "Liquidity, reconciliation, and bank accounts.", href: "/accounts-finance/bank-cash-management", icon: Landmark, metric: "$786.4K available" },
  { title: "Expense Tracking", description: "Expense claims, reimbursements, and exceptions.", href: "/accounts-finance/expense-tracking", icon: WalletCards, metric: "$164.8K MTD" },
  { title: "Financial Reporting", description: "Management packs and period-close reporting.", href: "/accounts-finance/financial-reporting", icon: ChartNoAxesCombined, metric: "78% close status" },
  { title: "Integrated Financial Accounting", description: "Controlled general ledger and journal activity.", href: "/accounts-finance/integrated-financial-accounting-system", icon: CalendarClock, metric: "1,284 journals" },
]
    ...
    <AppLayout>
      <main className="mx-auto max-w-[1600px] space-y-6 p-6 md:p-8">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            <div className="flex items-center gap-2"><h1 className="text-3xl font-bold tracking-tight">Accounts &amp; Finance</h1><Badge variant="outline" className="border-primary/20 bg-primary/5 text-primary">October 2024</Badge></div>
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {[
            ["Cash available", "$786.4K", "+12.8% vs last month", "text-emerald-600"],
            ["Receivables due", "$428.6K", "8 invoices due this week", "text-amber-600"],
            ["Payables scheduled", "$312.8K", "Next payment run: Friday", "text-primary"],
            ["Portfolio contribution", "$842.6K", "16.8% projected gross margin", "text-emerald-600"],
