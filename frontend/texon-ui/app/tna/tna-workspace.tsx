...
export function TnAWorkspace({ module, metrics, rows, rawItems }: { module: ModuleKey; metrics?: WorkspaceConfig["metrics"]; rows?: WorkspaceConfig["rows"]; rawItems?: Record<string, unknown>[] }) {
